...
Prioritize customers with repeated delinquency history
...
Flag customers with high credit utilization
...
Use combined risk signals for risk-based prioritization
...
Investigate customers with high DebtRatio and available income information
